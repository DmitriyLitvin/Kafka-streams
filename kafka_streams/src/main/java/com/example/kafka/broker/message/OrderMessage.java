...
public class OrderMessage {
	...
	public OrderMessage copy() {
		...
		orderMessage.setCreditCardNumber(this.creditCardNumber);
		orderMessage.setItemName(this.itemName);
		orderMessage.setOrderDateTime(this.orderDateTime);
		orderMessage.setOrderLocation(this.orderLocation);;
		orderMessage.setOrderNumber(this.orderNumber);
		orderMessage.setPrice(this.price);
		orderMessage.setQuantity(this.quantity);
