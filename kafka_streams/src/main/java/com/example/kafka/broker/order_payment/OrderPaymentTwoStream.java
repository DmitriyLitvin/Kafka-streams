...
public class OrderPaymentTwoStream {
    ...
    public KStream<String, OnlineOrderMessage> kStreamOrderPayment(StreamsBuilder streamsBuilder) {
        ...
        orderStream.leftJoin(paymentStream, this::joinerOrderPayment, JoinWindows.of(Duration.ofHours(1)),
                StreamJoined.with(stringSerde, orderSerde, paymentSerde))
                .through("t.commodity.join-order-payment-two", Produced.with(stringSerde, orderPaymentSerde))
